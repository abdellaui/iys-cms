...
ini_set("sendmail_from", "info@residence-service.de");
ini_set("auth_username", "info@residence-service.de");
ini_set("auth_password", "1905gs1905gs");



// $to      = 'web-g7m7u@mail-tester.com';
// $subject = 'the subject';
// $mailAdresse = "info@residence-service.de";
// $message = 'hello';
// $headers = 'From: info@residence-service.de' . "\r\n" .
//     'Reply-To: info@residence-service.de' . "\r\n" .
...
function mail_att($to,$subject,$message,$attachments,$typ)
   {
   $absender = "RESIDENCE SERVICE";
   $absender_mail = "info@residence-service.de";
   $mailAdresse = "info@residence-service.de";
                              ...
                              <td align="middle">
                                <div class="contentEditableContainer contentImageEditable">
                                  <div class="contentEditable">
                                    <img src="https://residence-service.de/img/logo/residence_service_gross.png" alt="RESIDENCE SERVICE" width=\'307\' data-default="placeholder" data-max-width="307">
                                  <br>
								  <br>
								  </div>
                                </div>
                              ...
                              <td align="middle" >
                                <div class="contentEditableContainer contentTextEditable">
                                  <div class="contentEditable">
									...
									$arr = [
									['Startseite', 'https://residence-service.de/startseite'],
									['Dienstleistungen', 'https://residence-service.de/dienstleistungen'],
									['Über Uns', 'https://residence-service.de/ueberuns'],
									['Angebot Anfordern', 'https://residence-service.de/angebot'],
									['Jobs', 'https://residence-service.de/jobs'],
									['Kontakt','https://residence-service.de/kontakt']
									]; 
									foreach($arr AS $k => $v){
										$message .= '
									...
									<tr><td>
									<b>RESIDENCE SERVICE</b> | Borsigstrasse 7 - 40880 Ratingen | 02102 / 532 79 83
									</td></tr>
									</table>
                                  </div>
                                </div>
...
if($_GET['page'] == 1 && isset($_POST['dienstleistung']) && isset($_POST['stadt_angebot']) && isset($_POST['ihr_name']) && isset($_POST['email'])){

$subject = '[Anfrage] '.htmlspecialchars($_POST['dienstleistung']).' - '.htmlspecialchars($_POST['stadt_angebot']).' [RESIDENCE-SERVICE]';
$body = '<tr>
			<td>
				<p>Vielen Dank <b>'.htmlspecialchars($_POST['anrede']).' '.htmlspecialchars($_POST['ihr_name']).'</b>,</p>
				<p>dass Sie Residence Service als Dienstleister Ihres Vertrauens anerkennen und eine Anfrage stellen!</p>
		...
		<tr>
			<td>Dienstleistung: <b>'.htmlspecialchars($_POST['dienstleistung']).'</b></td>
		</tr>
		<tr>
			<td>Turnus: <b>'.keineAngabe($_POST['turnus']).'</b></td>
		</tr>
		<tr>
...
echo mail_att($_POST['email'],$subject,templateMail($subject,$body),$attachments,1);
	...
	if(empty($_POST['dienstleistung'])){
	$error .= '<li>Inhalt für [dienstleistung] wurde nicht gefunden!</li>'; }
	...
	echo $error;
		...
		$subject = '[Kontaktanfrage] '.htmlspecialchars($_POST['betreff']).' [RESIDENCE-SERVICE]';
...
$subject = '[Bewerbung] '.htmlspecialchars($_POST['anrede']).' '.htmlspecialchars($_POST['ihr_name']).' [RESIDENCE-SERVICE]';
$body = '<tr>
			<td>
				<p>Vielen Dank <b>'.htmlspecialchars($_POST['anrede']).' '.htmlspecialchars($_POST['ihr_name']).'</b>,</p>
				<p>dass Sie sich bei Residence Service beworben haben!</p>
